...
function parseInputParameters() {
  ...
  const subjectCurrentAge = num("subjectAge");
  const subjectRetireAge = num("retireAge");
  const subjectLifeSpan = num("endAge");
  const subject401kStartAge = num("subject401kStartAge");
  const subjectPensionStartAge = num("penStart");
  const subjectSsStartAge = num("ssStart");

  const partnerCurrentAge = num("partnerAge");
  const partnerRetireAge = num("partnerRetireAge");
  const partnerLifeSpan = num("endAge");
